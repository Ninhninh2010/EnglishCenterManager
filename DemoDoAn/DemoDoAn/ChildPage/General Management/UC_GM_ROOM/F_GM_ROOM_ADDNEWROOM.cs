...
namespace DemoDoAn.ChildPage.General_Management.UC_GM_ROOM
{
    public partial class F_GM_ROOM_ADDNEWROOM : Form
    {
        ...
        private void txt_TenPhongHoc_Click(object sender, EventArgs e)
        {
            if (isEmpty_Search == true)
            {
                txt_TenPhongHoc.Text = String.Empty;
                txt_TenPhongHoc.Font = new Font(txt_TenPhongHoc.Font, FontStyle.Regular);
                txt_TenPhongHoc.ForeColor = Color.White;
