...
namespace DemoDoAn.ChildPage.QLThuChi
{
    public partial class UC_THUCHI_CHI : UserControl
    {
        ...
        private void thongKeChiTieu()
        {
            int chiNgay = 0;
            int chiThang = 0;
            for(int r = 0; r < dtPC.Rows.Count - 1; r++)
            {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            thucHienTimKiem(dataGrView_DSPhieuChi, duLieu);
        }
        //thuc hien tim kiem
        ...
        {
            thucHienReset(dataGrView_DSPhieuChi, txt_Search);
        }
        //thuc hien reset
        ...
        private void dataGrView_DSPhieuChi_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            ...
            if (row != dataGrView_DSPhieuChi.Rows[dataGrView_DSPhieuChi.Rows.Count - 1])
            {
