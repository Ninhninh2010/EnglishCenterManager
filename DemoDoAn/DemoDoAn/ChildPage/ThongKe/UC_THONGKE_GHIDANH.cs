...
namespace DemoDoAn.ChildPage.ThongKe
{
    public partial class UC_THONGKE_GHIDANH : UserControl
    {
        ...
        {
            lbl_TongGhiDanh.Text = dtGhiDanh.Rows.Count.ToString();
            int s = 0;
            ...
            lbl_GhiDanhTrongThang.Text = s.ToString();
        }
        ...
        private void dataGrView_GhiDanh_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
