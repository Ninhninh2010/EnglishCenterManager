...
namespace DemoDoAn
{
    internal class LopHocDao
    {
        ...
        {
            string sqlStr = string.Format("Update LOPHOC Set SoBuoiTrongTuan = '{0}', DiemTBQuaMon = '{1}', GiangVien = '{2}', SoHocVien = '{3}', NgayBatDau = '{4}', NgayKetThuc = '{5}' Where MaLop = '{6}'",lop.SOBUOITRONGTUAN, 8.0, lop.GIANGVIEN, lop.SOHOCVIEN, lop.NGAYBATDAU, lop.NGAYKETTHUC, lop.MALOP  );
